...
const variantStyles: Record<TagVariant, string> = {
  ...
  outline:
    'bg-white dark:bg-transparent text-zinc-500 dark:text-zinc-400 border-zinc-200 dark:border-zinc-700',
  emerald:
...
export const Tag = memo<TagProps>(
  ({ children, variant = 'light', size = 'md', className, style, onClick }) => {
